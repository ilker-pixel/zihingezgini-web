#!/usr/bin/env python3
"""Create compact visual-QA sheets from representative pages of all fifth-batch PDFs."""
...
RENDERS = ROOT / "tmp" / "fifth-twenty-pdf-renders"
OUT = ROOT / "tmp" / "fifth-twenty-summaries"
BOOKS = (15, 19, 24, 40, 48, 59, 65, 73, 82, 96, 109, 127, 141, 154, 173, 193, 220, 240, 263, 290)
...
def main() -> None:
    ...
    for group_index in range(4):
        ...
        canvas.save(OUT / f"fifth-twenty-pdf-contact-{group_index + 1}.jpg", quality=90)
