#!/usr/bin/env python3
"""Render every page of the first 80-book wave and build visual contact sheets."""
...
BOOKS = (21, 42, 69, 94, 137, 159, 190, 217, 118, 215)
OUT = ROOT / "tmp" / "eighty-wave-1-pdf-renders"
