#!/usr/bin/env python3
"""Mark final wave six as summarized and site-ready after QA."""
...
NUMBERS = {261, 262, 264, 265, 267, 268, 269, 270, 272}
...
print(f"Marked {len(found)} final-wave-six works as site-ready")
