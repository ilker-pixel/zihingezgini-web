#!/usr/bin/env python3
"""Mark final wave three as summarized and site-ready after QA."""
...
NUMBERS = {175, 177, 180, 198, 202, 203, 206, 207, 208}
...
print(f"Marked {len(found)} final-wave-three works as site-ready")
