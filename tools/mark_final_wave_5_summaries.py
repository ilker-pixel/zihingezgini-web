#!/usr/bin/env python3
"""Mark final wave five as summarized and site-ready after QA."""
...
NUMBERS = {236, 237, 246, 247, 249, 250, 252, 257, 260}
...
print(f"Marked {len(found)} final-wave-five works as site-ready")
