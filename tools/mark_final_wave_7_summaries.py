#!/usr/bin/env python3
"""Mark final wave seven as summarized and site-ready after QA."""
...
NUMBERS = {273, 274, 276, 278, 279, 280, 281, 282, 283}
...
print(f"Marked {len(found)} final-wave-seven works as site-ready")
