#!/usr/bin/env python3
"""Mark final wave two as summarized and site-ready after QA."""
...
NUMBERS = {128, 131, 132, 133, 134, 144, 148, 170, 174}
...
print(f"Marked {len(found)} final-wave-two works as site-ready")
