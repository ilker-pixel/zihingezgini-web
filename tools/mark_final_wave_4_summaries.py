#!/usr/bin/env python3
"""Mark final wave four as summarized and site-ready after QA."""
...
NUMBERS = {219, 226, 227, 228, 230, 231, 232, 233, 234}
...
print(f"Marked {len(found)} final-wave-four works as site-ready")
